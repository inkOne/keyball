...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_universal(
    ...
    MO(3)  , MO(1), KC_LCTL  , KC_LALT  , KC_LGUI, KC_SPC,   MO(5),                         LT(3 ,KC_ENT),LT(2,KC_BSPC), _______,KC_RGUI, _______ , KC_RALT  , _______
  ),
...
//   RGB_TOG  , _______  , _______  , _______  , _______  , _______  ,                                  _______  , _______  , _______  , _______  , _______  , _______  ,
 ...
 // ),
  ...
  [3] = LAYOUT_universal(
    RGB_TOG  , CPI_D1K  , CPI_D100 , CPI_I100 , CPI_I1K  ,  KBC_SAVE ,                                KC_MPRV , KC_MPLY,    KC_MNXT, KC_MUTE, KC_VOLD , KC_VOLU ,
    _______  ,RGB_MOD  , RGB_HUI  , RGB_SAI  , RGB_VAI  ,  KBC_RST,                             KC_HOME  , KC_PAGE_DOWN , KC_PAGE_UP,  KC_END  , KC_BRID,    KC_BRIU,
...
const rgblight_segment_t PROGMEM my_layer_mouse2[] = RGBLIGHT_LAYER_SEGMENTS(
